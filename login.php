...
<?php
$connect =mysqli_connect("localhost","root","","Internalyze") or die("Connection Failed");
if(!empty($_POST['save']))
{
    $username=$_POST['un'];
    $password=$_POST['pw'];
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" name="myForm" action="fetch.php"  method="post">
