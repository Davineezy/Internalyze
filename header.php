<!DOCTYPE html>
<!--  Last Published: Thu Jun 18 2020 16:26:23 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="5ede91aa7bf483d4c6951ead" data-wf-site="5ede91aa7bf48330cb951eae">
<head>
  <meta charset="utf-8">
  <title>Internalyze</title>
  ...
  <link href="css/internalyze-c172325c063499ba83dddb5a46f.webflow.css" rel="stylesheet" type="text/css">
  <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js" type="text/javascript"></script>
  <script type="text/javascript">WebFont.load({  google: {    families: ["Comfortaa:regular","Spartan:100,200,300,regular,500,600,700,800,900"]  }});</script>
  <!-- [if lt IE 9]><script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js" type="text/javascript"></script><![endif] -->
  <script type="text/javascript">!function(o,c){var n=c.documentElement,t=" w-mod-";n.className+=t+"js",("ontouchstart"in o||o.DocumentTouch&&c instanceof DocumentTouch)&&(n.className+=t+"touch")}(window,document);</script>
  <link href="images/favicon.png" rel="shortcut icon" type="image/x-icon">
  <link href="images/webclip.jpg" rel="apple-touch-icon">
  <script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-169293913-1"></script>
  <script type="text/javascript">window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'UA-169293913-1', {'anonymize_ip': false});</script>
</head>
<body class="body">
  <div data-collapse="medium" data-animation="default" data-duration="400" role="banner" class="navbar-2 w-nav">
    <div class="container-5 w-container"><a href="index.html" class="w-nav-brand"><img src="images/logo_long.png" width="169" srcset="images/logo_long-p-500.png 500w, images/logo_long-p-800.png 800w, images/logo_long-p-1080.png 1080w, images/logo_long-p-1600.png 1600w, images/logo_long-p-2000.png 2000w, images/logo_long.png 2048w" sizes="(max-width: 479px) 70vw, 169px" alt="" class="image-7"></a>
  ...
  <div class="w-container">
    <h1 id="what-we-do" class="section1">WHAT WE DO:</h1>
    <div class="section1">
      <div class="w-row">
        <div class="w-col w-col-6">
          <div class="w-layout-grid grid-2"><img src="images/noun_launch_2217254.png" width="175" srcset="images/noun_launch_2217254-p-500.png 500w, images/noun_launch_2217254.png 512w" sizes="(max-width: 479px) 89vw, 175px" id="w-node-1a8c281c734e-c6951ead" alt="">
            <div id="w-node-d0acc2d33b56-c6951ead" class="text-block">Help you launch your new career in tech via entry level sales roles</div>
          </div>
        </div>
        <div class="w-col w-col-6">
          <div class="w-layout-grid grid-2"><img src="images/noun_shake-hand_1546237.png" width="175" srcset="images/noun_shake-hand_1546237-p-500.png 500w, images/noun_shake-hand_1546237.png 512w" sizes="(max-width: 479px) 89vw, 175px" id="w-node-1ab1f43e6cdd-c6951ead" alt="">
            <div id="w-node-9af08c22b15a-c6951ead" class="text-block">Connect you directly with your next employer</div>
          </div>
        </div>
      </div>
    </div>
